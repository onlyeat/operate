...
public class CheckFileDownLoad {
	...
	public void downWxFile() {
		...
		//1- ftp 获取对账文件
		ftpOperation.downloadFile2("G:/javaTest/", "G_ZBCC_POST_[20191015]_W.txt", "C:/");
		//2- 入库
		Boolean wBoolean = bankDetailService.importFile(day,"G:/javaTest/G_ZBCC_POST_[20191015]_W.txt");
